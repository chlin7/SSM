...
import com.soft.webapp.framework.constants.APICons;
import com.soft.webapp.framework.enums.ErrorCodeEnum;
import com.soft.webapp.framework.model.ErrorCode;
import com.soft.webapp.framework.responses.ResponseResult;
import com.soft.webapp.framework.responses.FailedResponse;
import com.soft.webapp.framework.wrapper.ResponseWrapper;
...
public abstract class ResponseUtils {
    ...
    public static void sendFail(HttpServletRequest request, HttpServletResponse response, ErrorCode code,
								Exception exception) {
        ResponseUtils.writeValAsJson(request, getWrapper(response, code), ResponseResult.failure(code, exception));
    }
