...
public class ResponseWrapper extends HttpServletResponseWrapper {
    ...
    public void writerErrorMsg(Exception e) {
        ...
        printWriterApiResponses(ResponseResult.failure(this.getErrorCode(), e));
    }
     ...
     * @param apiResponses
     */
    public void printWriterApiResponses(ResponseResult apiResponses) {
